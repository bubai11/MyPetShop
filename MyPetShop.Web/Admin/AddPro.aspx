...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <asp:RangeValidator ID="rvListPrice" runat="server" ControlToValidate="txtListPrice" ErrorMessage="商品单价必须为数字" Type="Currency" MinimumValue="0" MaximumValue="999999.99" ForeColor="Red" />
        </div>
        <div class="form-group">
            ...
            <asp:RangeValidator ID="rvUnitCost" runat="server" ControlToValidate="txtUnitCost" ErrorMessage="单位成本必须为数字" Type="Currency" MinimumValue="0" MaximumValue="999999.99" ForeColor="Red" />
        </div>
        <div class="form-group">
