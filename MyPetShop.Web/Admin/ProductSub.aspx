...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
    ...
    <div class="container">  
        ...
        <asp:Button ID="btnUpdate" runat="server" Text="修改商品" OnClick="btnUpdate_Click" CssClass="btn-custom-update" />  
        <asp:Button ID="btnCancel" runat="server" Text="取消" OnClick="btnCancel_Click" CssClass="btn-custom-cancel" CausesValidation="False" />  
    </div>  
</asp:Content>