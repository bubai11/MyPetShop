...
<div class="userStatus">
    ...
    <asp:HyperLink ID="lnkAction1" runat="server" CssClass="ml-3 text-white"></asp:HyperLink>
    <asp:HyperLink ID="lnkAction2" runat="server" CssClass="ml-3 text-white"></asp:HyperLink>
    <asp:HyperLink ID="lnkAction3" runat="server" CssClass="ml-3 text-white"></asp:HyperLink>
</div>
